...
- Улеснен достъп → Позвъняване: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Улеснен достъп → Позвъняване → Позвъняване: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Улеснен достъп → Позвъняване → График: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Улеснен достъп → Позвъняване → График → На всеки час: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Улеснен достъп → Позвъняване → График → 30 минути: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Улеснен достъп → Позвъняване → График → 15 минути: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Улеснен достъп → Позвъняване → Звуци: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Улеснен достъп → Позвъняване → Звуци → Камбани: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Улеснен достъп → Позвъняване → Звуци → Птици: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
- Улеснен достъп → Движение: `bridge:root=ACCESSIBILITY#MotorGroupCell`
...
- Улеснен достъп → Улеснения за докосване → Продължителност на задържане: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- Улеснен достъп → Улеснения за докосване → Игнорирай Повторение: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- Карти | Предупреждения за завой → Информация за компилация:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`

...
- شاشة العرض والإضاءة → نص غامق: `bridge:root=DISPLAY_AND_BRIGHTNESS#BOLD_TEXT`
...
- عام → اللغة والمنطقة → محاكاة إعدادات iPhone: `bridge:root=GENERAL_LINK&path=LANGUAGE_AND_REGION#MIRROR_MY_COMPANION_ID`
...
- الخصوصية → تتبع اللياقة: `bridge:root=PRIVACY_ID#FITNESS_TRACKING_ENABLED_LABEL`
...
- تسهيلات الاستخدام → نص غامق: `bridge:root=ACCESSIBILITY#BoldTextEnabled`
...
- تسهيلات الاستخدام → صوت أجراس: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- تسهيلات الاستخدام → صوت أجراس → صوت أجراس: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- تسهيلات الاستخدام → صوت أجراس → جدول الأوقات: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- تسهيلات الاستخدام → صوت أجراس → جدول الأوقات → كل ساعة: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- تسهيلات الاستخدام → صوت أجراس → جدول الأوقات → كل ^[30](formatNumber: true) دقيقة: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- تسهيلات الاستخدام → صوت أجراس → جدول الأوقات → ^[15](formatNumber: true) دقيقة: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- تسهيلات الاستخدام → صوت أجراس → الأصوات: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- تسهيلات الاستخدام → صوت أجراس → الأصوات → أجراس: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- تسهيلات الاستخدام → صوت أجراس → الأصوات → طيور: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
- تسهيلات الاستخدام → الحركية: `bridge:root=ACCESSIBILITY#MotorGroupCell`
...
- تسهيلات الاستخدام → تسهيلات اللمس → مدة الضغط المطول: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- تسهيلات الاستخدام → تسهيلات اللمس → مدة الضغط المطول: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- تسهيلات الاستخدام → تسهيلات اللمس → تجاهل التكرار: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- تسهيلات الاستخدام → سرعة الوقت بالحس اللمسي: `bridge:root=ACCESSIBILITY#TapticTimeSpeedAdjustmentGroup`

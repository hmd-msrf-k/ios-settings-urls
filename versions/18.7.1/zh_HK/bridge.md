...
- 輔助使用 → 鐘聲: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- 輔助使用 → 鐘聲 → 鐘聲: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- 輔助使用 → 鐘聲 → 時間表: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- 輔助使用 → 鐘聲 → 時間表 → 每小時: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- 輔助使用 → 鐘聲 → 時間表 → 30分鐘: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- 輔助使用 → 鐘聲 → 時間表 → 15分鐘: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- 輔助使用 → 鐘聲 → 聲音: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- 輔助使用 → 鐘聲 → 聲音 → 鈴聲: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- 輔助使用 → 鐘聲 → 聲音 → 鳥: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- 輔助使用 → 觸控調節 → 持續點按時間: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- 輔助使用 → 觸控調節 → 持續點按時間: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- 輔助使用 → 觸控調節 → 忽略重複: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- 輔助使用 → 點一下開始説話: `bridge:root=ACCESSIBILITY#WalkieTalkieTapToTalk`

...
- ทั่วไป → เกี่ยวกับ → รุ่น: `bridge:root=GENERAL_LINK&path=ABOUT#DEVICE_MODEL_CELL_ID`
...
- เสียงและการสั่น → บังหน้าจอเพื่อปิดเสียง: `bridge:root=SOUNDS_ID#COVER_TO_MUTE`
...
- การช่วยการเข้าถึง → เสียงเตือน: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- การช่วยการเข้าถึง → เสียงเตือน → เสียงเตือน: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- การช่วยการเข้าถึง → เสียงเตือน → กำหนดเวลา: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- การช่วยการเข้าถึง → เสียงเตือน → กำหนดเวลา → ทุกชั่วโมง: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- การช่วยการเข้าถึง → เสียงเตือน → กำหนดเวลา → 30 นาที: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- การช่วยการเข้าถึง → เสียงเตือน → กำหนดเวลา → 15 นาที: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- การช่วยการเข้าถึง → เสียงเตือน → เสียง: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- การช่วยการเข้าถึง → เสียงเตือน → เสียง → กระดิ่ง: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- การช่วยการเข้าถึง → เสียงเตือน → เสียง → นก: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
- การช่วยการเข้าถึง → การควบคุม: `bridge:root=ACCESSIBILITY#MotorGroupCell`
...
- การช่วยการเข้าถึง → การช่วยปรับการสัมผัส → ระยะเวลากดค้าง: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- การช่วยการเข้าถึง → การช่วยปรับการสัมผัส → ไม่สนใจการกดซ้ำ: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

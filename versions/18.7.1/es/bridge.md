...
- Pantalla y brillo → Pantalla siempre activa: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID`
- Pantalla y brillo → Pantalla siempre activa → Pantalla siempre activa: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID#TRITIUM_ID`
- Pantalla y brillo → Pantalla siempre activa → MUÑECA BAJADA: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID#TRITIUM_PRIVACY_GROUP_ID`
- Pantalla y brillo → Pantalla siempre activa → Mostrar notificaciones: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications`
- Pantalla y brillo → Pantalla siempre activa → Mostrar notificaciones → Mostrar notificaciones: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- Pantalla y brillo → Pantalla siempre activa → Mostrar notificaciones → APPS DEL APPLE WATCH: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_GROUP_ID`
- Pantalla y brillo → Pantalla siempre activa → Mostrar apps: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps`
- Pantalla y brillo → Pantalla siempre activa → Mostrar apps → Mostrar apps: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- Pantalla y brillo → Pantalla siempre activa → Mostrar apps → APPS: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps#APP_GROUP_ID`
...
- Accesibilidad → Timbre: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Accesibilidad → Timbre → Timbre: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Accesibilidad → Timbre → Programar: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Accesibilidad → Timbre → Programar → Cada hora: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Accesibilidad → Timbre → Programar → 30 minutos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Accesibilidad → Timbre → Programar → 15 minutos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Accesibilidad → Timbre → Sonidos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Accesibilidad → Timbre → Sonidos → Campanas: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Accesibilidad → Timbre → Sonidos → Pájaros: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Accesibilidad → Facilidades táctiles → Mantener pulsado: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Accesibilidad → Facilidades táctiles → Mantener pulsado: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Accesibilidad → Facilidades táctiles → Ignorar repetición: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- Accesibilidad → Función rápida de accesibilidad: `bridge:root=ACCESSIBILITY&path=AX_SHORTCUT`
...
- Límite para fotos | Álbum seleccionado: `bridge:root=com.apple.mobileslideshow`

...
- Umum → Perihal → Waranti Terhad → BUTIRAN PERLINDUNGAN: `bridge:root=GENERAL_LINK&path=ABOUT/WARRANTY_DESCRIPTION#COVERAGE%20DETAILS`
- Umum → Perihal → Waranti Terhad → Perlindungan Perkakasan: `bridge:root=GENERAL_LINK&path=ABOUT/WARRANTY_DESCRIPTION#Hardware%20Coverage`
...
- Kebolehcapaian → Bunyi Loceng: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Kebolehcapaian → Bunyi Loceng → Bunyi Loceng: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Kebolehcapaian → Bunyi Loceng → Jadual: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Kebolehcapaian → Bunyi Loceng → Jadual → Setiap Jam: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Kebolehcapaian → Bunyi Loceng → Jadual → 30 minit: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Kebolehcapaian → Bunyi Loceng → Jadual → 15 minit: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Kebolehcapaian → Bunyi Loceng → Bunyi: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Kebolehcapaian → Bunyi Loceng → Bunyi → Loceng: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Kebolehcapaian → Bunyi Loceng → Bunyi → Burung: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Kebolehcapaian → Penyesuaian Sentuhan → Tempoh Penahanan: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Kebolehcapaian → Penyesuaian Sentuhan → Tempoh Penahanan: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Kebolehcapaian → Penyesuaian Sentuhan → Abaikan Ulangan: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

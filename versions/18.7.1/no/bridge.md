...
- Tilgjengelighet → Ringelyd: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Tilgjengelighet → Ringelyd → Ringelyd: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Tilgjengelighet → Ringelyd → Intervaller: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Tilgjengelighet → Ringelyd → Intervaller → Hver time: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Tilgjengelighet → Ringelyd → Intervaller → 30 minutter: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Tilgjengelighet → Ringelyd → Intervaller → 15 minutter: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Tilgjengelighet → Ringelyd → Lyder: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Tilgjengelighet → Ringelyd → Lyder → Bjeller: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Tilgjengelighet → Ringelyd → Lyder → Fugler: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Tilgjengelighet → Trykktilpassing → Varighet av trykk: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Tilgjengelighet → Trykktilpassing → Varighet av trykk: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Tilgjengelighet → Trykktilpassing → Ignorer gjentakelse: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

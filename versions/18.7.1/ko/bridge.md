...
- 디스플레이 및 밝기 → 화면 상시표시: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID`
- 디스플레이 및 밝기 → 화면 상시표시 → 화면 상시표시: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID#TRITIUM_ID`
- 디스플레이 및 밝기 → 화면 상시표시 → 손목 내리기: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID#TRITIUM_PRIVACY_GROUP_ID`
- 디스플레이 및 밝기 → 화면 상시표시 → 알림 보기: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications`
- 디스플레이 및 밝기 → 화면 상시표시 → 알림 보기 → 알림 보기: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- 디스플레이 및 밝기 → 화면 상시표시 → 알림 보기 → APPLE WATCH용 앱: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_GROUP_ID`
- 디스플레이 및 밝기 → 화면 상시표시 → 앱 보기: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps`
- 디스플레이 및 밝기 → 화면 상시표시 → 앱 보기 → 앱 보기: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- 디스플레이 및 밝기 → 화면 상시표시 → 앱 보기 → 앱: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps#APP_GROUP_ID`
...
- 캘린더 → 공유 캘린더 변경: `bridge:root=com.apple.NanoCalendarBridgeSettings&path=Shared%20Calendar%20Alerts`
...
- 손쉬운 사용 → 차임: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- 손쉬운 사용 → 차임 → 차임: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- 손쉬운 사용 → 차임 → 시간 지정: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- 손쉬운 사용 → 차임 → 시간 지정 → 매시간: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- 손쉬운 사용 → 차임 → 시간 지정 → 30분: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- 손쉬운 사용 → 차임 → 시간 지정 → 15분: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- 손쉬운 사용 → 차임 → 소리: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- 손쉬운 사용 → 차임 → 소리 → 종: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- 손쉬운 사용 → 차임 → 소리 → 새: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- 손쉬운 사용 → 터치 조절 → 대기 시간: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- 손쉬운 사용 → 터치 조절 → 대기 시간: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- 손쉬운 사용 → 터치 조절 → 반복 무시: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- 손쉬운 사용 → 청각 지원: `bridge:root=ACCESSIBILITY#HEARING`

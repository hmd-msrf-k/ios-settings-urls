...
- Confidentialité → Mesures du taux d’oxygène sanguin: `bridge:root=PRIVACY_ID#OXYGEN_SATURATION_ENABLED_SWITCH_ID`
...
- Accessibilité → Étiquettes Oui/Non: `bridge:root=ACCESSIBILITY#OnOffLabelsEnabled`
...
- Accessibilité → Carillons: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Accessibilité → Carillons → Carillons: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Accessibilité → Carillons → Horaire: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Accessibilité → Carillons → Horaire → Toutes les heures: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Accessibilité → Carillons → Horaire → 30 minutes: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Accessibilité → Carillons → Horaire → 15 minutes: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Accessibilité → Carillons → Sons: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Accessibilité → Carillons → Sons → Cloches: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Accessibilité → Carillons → Sons → Oiseaux: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Accessibilité → Adaptation tactile → Durée de mise en attente: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- Accessibilité → Adaptation tactile → Ignorer la répétition: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- Accessibilité → Équilibre stéréo gauche-droite: `bridge:root=ACCESSIBILITY#LEFT_RIGHT_BALANCE_SPOKEN`
...
- Accessibilité → Raccourci d’accessibilité: `bridge:root=ACCESSIBILITY&path=AX_SHORTCUT`

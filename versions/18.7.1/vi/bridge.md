...
- Trợ năng → Chuông gió: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Trợ năng → Chuông gió → Chuông gió: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Trợ năng → Chuông gió → Lịch trình: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Trợ năng → Chuông gió → Lịch trình → Hàng giờ: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Trợ năng → Chuông gió → Lịch trình → 30 phút: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Trợ năng → Chuông gió → Lịch trình → 15 phút: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Trợ năng → Chuông gió → Âm thanh: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Trợ năng → Chuông gió → Âm thanh → Chuông: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Trợ năng → Chuông gió → Âm thanh → Chim: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Trợ năng → Thích nghi cảm ứng → Thời gian giữ: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Trợ năng → Thích nghi cảm ứng → Thời gian giữ: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Trợ năng → Thích nghi cảm ứng → Bỏ qua lặp lại: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

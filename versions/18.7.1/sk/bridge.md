...
- Displej a jas → Trvalo zapnutý displej → Zobrazovať hlásenia: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications`
- Displej a jas → Trvalo zapnutý displej → Zobrazovať hlásenia → Zobrazovať hlásenia: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- Displej a jas → Trvalo zapnutý displej → Zobrazovať hlásenia → APKY Z APPLE WATCH: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_GROUP_ID`
...
- Prístupnosť → Odbíjanie: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Prístupnosť → Odbíjanie → Odbíjanie: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Prístupnosť → Odbíjanie → Rozvrh: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Prístupnosť → Odbíjanie → Rozvrh → Každú hodinu: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Prístupnosť → Odbíjanie → Rozvrh → 30 min: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Prístupnosť → Odbíjanie → Rozvrh → 15 min: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Prístupnosť → Odbíjanie → Zvuky: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Prístupnosť → Odbíjanie → Zvuky → Zvony: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Prístupnosť → Odbíjanie → Zvuky → Vtáky: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Prístupnosť → Prispôsobenie dotykov → Trvanie podržania: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Prístupnosť → Prispôsobenie dotykov → Trvanie podržania: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Prístupnosť → Prispôsobenie dotykov → Ignorovanie opakovania: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

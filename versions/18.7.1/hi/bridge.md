...
- नॉइज़ → सूचनाओं के समूह बनाना: `bridge:root=com.apple.Noise.settings&path=NOTIFICATION_COALESCING_ID`
...
- कैलेंडर → मेरी iPhone सेटिंग्ज़ मिरर करें: `bridge:root=com.apple.NanoCalendarBridgeSettings#MIRROR_MY_COMPANION_ID`
...
- ऐक्सेसिबिलिटी → चाइम: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- ऐक्सेसिबिलिटी → चाइम → चाइम: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- ऐक्सेसिबिलिटी → चाइम → शेड्यूल: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- ऐक्सेसिबिलिटी → चाइम → शेड्यूल → हर घंटे: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- ऐक्सेसिबिलिटी → चाइम → शेड्यूल → 30 मिनट: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- ऐक्सेसिबिलिटी → चाइम → शेड्यूल → 15 मिनट: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- ऐक्सेसिबिलिटी → चाइम → ध्वनियाँ: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- ऐक्सेसिबिलिटी → चाइम → ध्वनियाँ → घंटियाँ: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- ऐक्सेसिबिलिटी → चाइम → ध्वनियाँ → चिड़ियाँ: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- ऐक्सेसिबिलिटी → टच सुविधाएँ → होल्ड अवधि: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- ऐक्सेसिबिलिटी → टच सुविधाएँ → होल्ड अवधि: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- ऐक्सेसिबिलिटी → टच सुविधाएँ → दोहराना नज़रअंदाज़ करें: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

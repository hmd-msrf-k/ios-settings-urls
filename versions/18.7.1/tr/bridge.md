...
- Erişilebilirlik → Çanlar: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Erişilebilirlik → Çanlar → Çanlar: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Erişilebilirlik → Çanlar → Program: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Erişilebilirlik → Çanlar → Program → Her saat başı: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Erişilebilirlik → Çanlar → Program → 30 dakika: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Erişilebilirlik → Çanlar → Program → 15 dakika: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Erişilebilirlik → Çanlar → Sesler: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Erişilebilirlik → Çanlar → Sesler → Çanlar: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Erişilebilirlik → Çanlar → Sesler → Kuşlar: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Erişilebilirlik → Dokunma Kolaylıkları → Tutma Süresi: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Erişilebilirlik → Dokunma Kolaylıkları → Tutma Süresi: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Erişilebilirlik → Dokunma Kolaylıkları → Yinelemeyi Yok Say: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- Dönüş Uyarıları | Harita → Build Bilgisi:: `bridge:root=com.apple.NanoMapsBridgeSettings#Build%20Info%3A`

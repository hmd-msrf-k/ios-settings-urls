...
- 輔助使用 → 響鈴: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- 輔助使用 → 響鈴 → 響鈴: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- 輔助使用 → 響鈴 → 排程: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- 輔助使用 → 響鈴 → 排程 → 每小時: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- 輔助使用 → 響鈴 → 排程 → 30分鐘: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- 輔助使用 → 響鈴 → 排程 → 15分鐘: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- 輔助使用 → 響鈴 → 聲音: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- 輔助使用 → 響鈴 → 聲音 → 鈴聲: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- 輔助使用 → 響鈴 → 聲音 → 鳥: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- 輔助使用 → 觸控調節 → 按住持續時間: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`

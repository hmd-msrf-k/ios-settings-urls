...
- Acessibilidade → Avisos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Acessibilidade → Avisos → Avisos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Acessibilidade → Avisos → Horário: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Acessibilidade → Avisos → Horário → De hora em hora: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Acessibilidade → Avisos → Horário → 30 minutos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Acessibilidade → Avisos → Horário → 15 minutos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Acessibilidade → Avisos → Sons: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Acessibilidade → Avisos → Sons → Sinos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Acessibilidade → Avisos → Sons → Pássaros: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Acessibilidade → Botão lateral → Velocidade do clique: `bridge:root=ACCESSIBILITY&path=SideButton#SIDE_SPEED_HEADER`
...
- Acessibilidade → Opções de toque → Duração de pressão: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Acessibilidade → Opções de toque → Duração de pressão: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Acessibilidade → Opções de toque → Ignorar repetição: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- Acessibilidade → Equilíbrio estéreo esquerda‑direita: `bridge:root=ACCESSIBILITY#LEFT_RIGHT_BALANCE_SPOKEN`

...
- Звуки и вибрация → Тактильные сигналы: `bridge:root=SOUNDS_ID#Haptics`
- Звуки и вибрация → Тактильные оповещения: `bridge:root=SOUNDS_ID#Haptic%20Alerts`
...
- Звуки и вибрация → Накрыть для выкл. звука: `bridge:root=SOUNDS_ID#COVER_TO_MUTE`
...
- Универсальный доступ → Перезвон: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Универсальный доступ → Перезвон → Перезвон: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Универсальный доступ → Перезвон → Расписание: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Универсальный доступ → Перезвон → Расписание → Ежечасно: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Универсальный доступ → Перезвон → Расписание → Через 30 минут: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Универсальный доступ → Перезвон → Расписание → Через 15 минут: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Универсальный доступ → Перезвон → Звуки: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Универсальный доступ → Перезвон → Звуки → Колокольчики: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Универсальный доступ → Перезвон → Звуки → Птицы: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Универсальный доступ → Адаптация касания → Время фиксации: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- Универсальный доступ → Адаптация касания → Пропуск повтора: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

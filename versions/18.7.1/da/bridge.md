...
- Tilgængelighed → Klokkespil: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Tilgængelighed → Klokkespil → Klokkespil: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Tilgængelighed → Klokkespil → Planlæg: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Tilgængelighed → Klokkespil → Planlæg → Hver time: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Tilgængelighed → Klokkespil → Planlæg → 30 minutter: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Tilgængelighed → Klokkespil → Planlæg → 15 minutter: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Tilgængelighed → Klokkespil → Lyde: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Tilgængelighed → Klokkespil → Lyde → Klokker: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Tilgængelighed → Klokkespil → Lyde → Fugle: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
- Tilgængelighed → Motorik: `bridge:root=ACCESSIBILITY#MotorGroupCell`
- Tilgængelighed → Trykhastighed på sideknap: `bridge:root=ACCESSIBILITY&path=SideButton`
- Tilgængelighed → Trykhastighed på sideknap → Trykhastighed: `bridge:root=ACCESSIBILITY&path=SideButton#SIDE_SPEED_HEADER`
- Tilgængelighed → Trykhastighed på sideknap → Standard: `bridge:root=ACCESSIBILITY&path=SideButton#SIDE_CLICK_SPEED_DEFAULT`
- Tilgængelighed → Trykhastighed på sideknap → Langsom: `bridge:root=ACCESSIBILITY&path=SideButton#SIDE_CLICK_SPEED_SLOW`
- Tilgængelighed → Trykhastighed på sideknap → Langsomst: `bridge:root=ACCESSIBILITY&path=SideButton#SIDE_CLICK_SPEED_SLOWEST`
...
- Tilgængelighed → Tilpasning af berøring → Varighed af tryk: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- Tilgængelighed → Tilpasning af berøring → Ignorer gentagelse: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

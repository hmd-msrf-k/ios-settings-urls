...
- Accessibilité → Carillon: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Accessibilité → Carillon → Carillon: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Accessibilité → Carillon → Programme: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Accessibilité → Carillon → Programme → Toutes les heures: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Accessibilité → Carillon → Programme → 30 minutes: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Accessibilité → Carillon → Programme → 15 minutes: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Accessibilité → Carillon → Sons: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Accessibilité → Carillon → Sons → Cloches: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Accessibilité → Carillon → Sons → Oiseaux: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Accessibilité → Adaptation aux pressions → Durée du maintien: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- Accessibilité → Adaptation aux pressions → Ignorer la répétition: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

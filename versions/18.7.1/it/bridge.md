...
- Accessibilità → Rintocchi: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Accessibilità → Rintocchi → Rintocchi: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Accessibilità → Rintocchi → Intervallo: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Accessibilità → Rintocchi → Intervallo → Ogni ora: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Accessibilità → Rintocchi → Intervallo → Ogni 30 minuti: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Accessibilità → Rintocchi → Intervallo → Ogni 15 minuti: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Accessibilità → Rintocchi → Suoni: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Accessibilità → Rintocchi → Suoni → Campane: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Accessibilità → Rintocchi → Suoni → Uccelli: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Accessibilità → Regolazione tocco → Durata pressione: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Accessibilità → Regolazione tocco → Durata pressione: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Accessibilità → Regolazione tocco → Ignora ripetizione: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- Accessibilità → Abbreviazione: `bridge:root=ACCESSIBILITY&path=AX_SHORTCUT`

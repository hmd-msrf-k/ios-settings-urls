...
- Дисплей және жарықтық: `bridge:root=DISPLAY_AND_BRIGHTNESS`
- Дисплей және жарықтық → Ояну ұзақтығы: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=Wake%20Duration`
- Дисплей және жарықтық → Ояну ұзақтығы → ТҮРТКЕННЕН КЕЙІН: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=Wake%20Duration#ON_TAP_GROUP_ID`
- Дисплей және жарықтық → Ояну ұзақтығы → 15 секунд белсенді: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=Wake%20Duration#SHORT_WAKE_ID`
- Дисплей және жарықтық → Ояну ұзақтығы → 70 секунд белсенді: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=Wake%20Duration#LONG_WAKE_ID`
- Дисплей және жарықтық → Жарықтық: `bridge:root=DISPLAY_AND_BRIGHTNESS#BRIGHTNESS_LABEL`
- Дисплей және жарықтық → Әрдайым қосулы: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID`
- Дисплей және жарықтық → Әрдайым қосулы → Әрдайым қосулы: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID#TRITIUM_ID`
- Дисплей және жарықтық → Әрдайым қосулы → БІЛЕК ТӨМЕН ТҮСІРІЛГЕНДЕ: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID#TRITIUM_PRIVACY_GROUP_ID`
- Дисплей және жарықтық → Әрдайым қосулы → Хабарландыруларды көрсету: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications`
- Дисплей және жарықтық → Әрдайым қосулы → Хабарландыруларды көрсету → Хабарландыруларды көрсету: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- Дисплей және жарықтық → Әрдайым қосулы → Хабарландыруларды көрсету → APPLE WATCH САҒАТЫНА АРНАЛҒАН ҚОЛДАНБАЛАР: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_GROUP_ID`
- Дисплей және жарықтық → Әрдайым қосулы → Қолданбаларды көрсету: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps`
- Дисплей және жарықтық → Әрдайым қосулы → Қолданбаларды көрсету → Қолданбаларды көрсету: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- Дисплей және жарықтық → Әрдайым қосулы → Қолданбаларды көрсету → ҚОЛДАНБАЛАР: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps#APP_GROUP_ID`
- Дисплей және жарықтық → Мәтін өлшемі: `bridge:root=DISPLAY_AND_BRIGHTNESS#TEXT_SIZE`
- Дисплей және жарықтық → Қалың қаріпті мәтін: `bridge:root=DISPLAY_AND_BRIGHTNESS#BOLD_TEXT`
- Дисплей және жарықтық → ҰЙҚЫ РЕЖИМІНЕН ШЫҒУ: `bridge:root=DISPLAY_AND_BRIGHTNESS#WAKE`
- Дисплей және жарықтық → Білекті көтерген кезде ояну: `bridge:root=DISPLAY_AND_BRIGHTNESS#WAKE_SCREEN_ON_WRIST_RAISE_SWITCH_ID`
- Дисплей және жарықтық → Дөңгелекшені айналдырған кезде ояну: `bridge:root=DISPLAY_AND_BRIGHTNESS#WAKE_SCREEN_ON_CROWN_UP_SWITCH_ID`
...
- Құпиялылық → Калибрлеу дерегін нөлдеу: `bridge:root=PRIVACY_ID#RESET_MOTION_CALIBRATION_LABEL`
...
- Әмбебап қол жеткізу → Қоңырау үні: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Әмбебап қол жеткізу → Қоңырау үні → Қоңырау үні: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Әмбебап қол жеткізу → Қоңырау үні → Кесте: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Әмбебап қол жеткізу → Қоңырау үні → Кесте → Сағат сайын: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Әмбебап қол жеткізу → Қоңырау үні → Кесте → 30 минут: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Әмбебап қол жеткізу → Қоңырау үні → Кесте → 15 минут: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Әмбебап қол жеткізу → Қоңырау үні → Дыбыстар: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Әмбебап қол жеткізу → Қоңырау үні → Дыбыстар → Қоңыраулар: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Әмбебап қол жеткізу → Қоңырау үні → Дыбыстар → Құстар: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Әмбебап қол жеткізу → Түрту әрекетін бейімдеу → Ұстап тұру ұзақтығы: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- Әмбебап қол жеткізу → Түрту әрекетін бейімдеу → Қайталауды елемеу: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`

...
- Tela e Brilho → ACENDER: `bridge:root=DISPLAY_AND_BRIGHTNESS#WAKE`
...
- Resposta Tátil e Som → Segurança de Fone de Ouvido → Limite de Volume: `bridge:root=SOUNDS_ID&path=HEADPHONE_LEVEL_LIMIT_SETTING#COSHeadphoneLevelLimitSwitchKey`
- Resposta Tátil e Som → Resposta Tátil: `bridge:root=SOUNDS_ID#Haptics`
- Resposta Tátil e Som → Alertas Táteis: `bridge:root=SOUNDS_ID#Haptic%20Alerts`
...
- Resposta Tátil e Som → Cobrir para Silenciar: `bridge:root=SOUNDS_ID#COVER_TO_MUTE`
...
- Acessibilidade → Toques: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Acessibilidade → Toques → Toques: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Acessibilidade → Toques → Horários: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Acessibilidade → Toques → Horários → A cada hora: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Acessibilidade → Toques → Horários → 30 minutos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Acessibilidade → Toques → Horários → 15 minutos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Acessibilidade → Toques → Sons: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Acessibilidade → Toques → Sons → Sinos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Acessibilidade → Toques → Sons → Pássaros: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Acessibilidade → Adaptações de Toque → Duração ao Pressionar: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- Acessibilidade → Adaptações de Toque → Ignorar Repetição: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- Coração → Notificações de Batimentos: `bridge:root=com.apple.HeartRateSettings#2`

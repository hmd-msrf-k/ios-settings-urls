...
- Hjälpmedel → Klockspel: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Hjälpmedel → Klockspel → Klockspel: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Hjälpmedel → Klockspel → Schema: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Hjälpmedel → Klockspel → Schema → Timvis: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Hjälpmedel → Klockspel → Schema → 30 minuter: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Hjälpmedel → Klockspel → Schema → 15 minuter: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Hjälpmedel → Klockspel → Ljud: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Hjälpmedel → Klockspel → Ljud → Klockor: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Hjälpmedel → Klockspel → Ljud → Fåglar: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
...
- Hjälpmedel → Pekhjälpmedel → Hålltid: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
- Hjälpmedel → Pekhjälpmedel → Hålltid: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDuration`
- Hjälpmedel → Pekhjälpmedel → Ignorera upprepning: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
...
- Hitta min Apple Watch → Parkoppla en ny klocka: `bridge:root=ActiveWatch&path=Pair%20New%20Watch`

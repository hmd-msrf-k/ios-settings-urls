...
- Pantalla y brillo → Siempre activa: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID`
- Pantalla y brillo → Siempre activa → Siempre activa: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID#TRITIUM_ID`
- Pantalla y brillo → Siempre activa → AL BAJAR MUÑECA: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID#TRITIUM_PRIVACY_GROUP_ID`
- Pantalla y brillo → Siempre activa → Mostrar notificaciones: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications`
- Pantalla y brillo → Siempre activa → Mostrar notificaciones → Mostrar notificaciones: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- Pantalla y brillo → Siempre activa → Mostrar notificaciones → APPS PARA APPLE WATCH: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Notifications#APP_GROUP_ID`
- Pantalla y brillo → Siempre activa → Mostrar apps: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps`
- Pantalla y brillo → Siempre activa → Mostrar apps → Mostrar apps: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps#APP_BACKLIGHT_PRIVACY_GLOBAL_APP`
- Pantalla y brillo → Siempre activa → Mostrar apps → APPS: `bridge:root=DISPLAY_AND_BRIGHTNESS&path=TRITIUM_ID/Show%20Apps#APP_GROUP_ID`
...
- Accesibilidad → Carillón: `bridge:root=ACCESSIBILITY&path=TapticChimesCell`
- Accesibilidad → Carillón → Carillón: `bridge:root=ACCESSIBILITY&path=TapticChimesCell#Chimes`
- Accesibilidad → Carillón → Horario: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule`
- Accesibilidad → Carillón → Horario → Cada hora: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#Hourly`
- Accesibilidad → Carillón → Horario → 30 minutos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#30%20minutes`
- Accesibilidad → Carillón → Horario → 15 minutos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Schedule#15%20minutes`
- Accesibilidad → Carillón → Sonidos: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds`
- Accesibilidad → Carillón → Sonidos → Campanas: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Bells`
- Accesibilidad → Carillón → Sonidos → Aves: `bridge:root=ACCESSIBILITY&path=TapticChimesCell/Sounds#Birds`
- Accesibilidad → Motricidad: `bridge:root=ACCESSIBILITY#MotorGroupCell`
...
- Accesibilidad → Adaptaciones táctiles → Duración de presión: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#HoldDurationGroup`
...
- Accesibilidad → Adaptaciones táctiles → Ignorar repetición: `bridge:root=ACCESSIBILITY&path=TouchAccommodationsCell#IgnoreRepeatGroup`
